                ...
                {activeTab === 'chat' && (
                    <div className="space-y-5 animate-fadeIn">
                        ...
                        <div className="space-y-4 pt-4 border-t border-neutral-50">
                            ...
                            <div className="space-y-1.5">
                                <label className="text-[11px] font-bold text-neutral-500 uppercase">장식 색상</label>
                                <div className="flex gap-2">
                            ...
                            <div className="space-y-4">
                                <div className="space-y-2">
                                    <div className="flex justify-between items-end">
                                        <label className="text-[11px] font-bold text-neutral-500 uppercase">장식 너비</label>
                                ...
                                <div className="space-y-2">
                                    <div className="flex justify-between items-end">
                                        <label className="text-[11px] font-bold text-neutral-500 uppercase">장식 높이</label>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid gap-2">
                                ...
                                <div className="flex items-center gap-3 p-4 bg-neutral-50 rounded-xl border border-neutral-100 hover:bg-neutral-100/80 transition-colors cursor-pointer group" 
                                    ...
                                    <span className="text-xs text-neutral-700 font-bold">왼쪽 정렬 (체크 해제 시 중앙)</span>
                                </div>
                            ...
                            {showDonationOutline && (
                                <div className="space-y-4 pt-4 border-t border-neutral-100 animate-fadeIn">
                                    <div className="space-y-2">
                                        <div className="flex justify-between items-end">
                                            <label className="text-[11px] font-bold text-neutral-500 uppercase">테두리 밝기</label>
                                    ...
                                    <div className="space-y-2">
                                        <div className="flex justify-between items-end">
                                            <label className="text-[11px] font-bold text-neutral-500 uppercase">테두리 투명도</label>
                                    ...
                                    <div className="space-y-2">
                                        <div className="flex justify-between items-end">
                                            <label className="text-[11px] font-bold text-neutral-500 uppercase">테두리 두께</label>
                                    ...
                                    <div className="space-y-2">
                                        <div className="flex justify-between items-end">
                                            <label className="text-[11px] font-bold text-neutral-500 uppercase">점선 간격</label>
